<template>
    <div class="game-area">
        <h1 class="title">
            Poğaça <span>Nerede</span> <strong>?</strong>
        </h1>
...
/*********Açık Kartların Animasyonları için gerekli olan stil işlemleri */
.rotate-all-enter{}
...
/*********Kapalı Kartların Animasyonları için gerekli olan stil işlemleri */
